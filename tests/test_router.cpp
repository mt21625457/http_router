...
private:
    ...
    void test_add_and_find_static_route()
    {
        ...
        int result = r.find_route(HttpMethod::GET, "/users", found_handler, params, query_params);
    ...
    void test_find_non_existent_route()
    {
        ...
        int result =
            r.find_route(HttpMethod::GET, "/nonexistent", found_handler, params, query_params);
    ...
    void test_parameterized_route()
    {
        ...
        int result =
            r.find_route(HttpMethod::GET, "/users/123", found_handler, params, query_params);
    ...
    void test_multiple_parameters_route()
    {
        ...
        int result = r.find_route(HttpMethod::GET, "/users/123/posts/456", found_handler, params,
                                  query_params);
    ...
    void test_wildcard_route()
    {
        ...
        int result = r.find_route(HttpMethod::GET, "/static/css/style.css", found_handler, params,
                                  query_params);
    ...
    void test_query_parameters()
    {
        ...
        int result = r.find_route(HttpMethod::GET, "/search?q=test&page=1&sort=date", found_handler,
                                  params, query_params);
    ...
    void test_different_http_methods()
    {
        ...
        std::vector<std::pair<HttpMethod, std::shared_ptr<MockHandler>>> test_cases = {
        ...
        for (const auto &[method, expected_handler] : test_cases) {
            ...
            int result = r.find_route(method, "/users", found_handler, params, query_params);
            assert(result == 0);
    ...
    void test_clear_cache()
    {
        ...
        // Add to cache
        r.find_route(HttpMethod::GET, "/users", found_handler, params, query_params);
    ...
    void test_complex_route_patterns()
    {
        ...
        params.clear();
        result = r.find_route(HttpMethod::GET, "/files/documents/download/report.pdf",
                              found_handler, params, query_params);
        assert(result == 0);
        ...
        params.clear();
        result = r.find_route(HttpMethod::GET, "/proxy/api/users/profile", found_handler, params,
                              query_params);
        assert(result == 0);
    ...
    void test_route_conflicts()
    {
        ...
        r.add_route(HttpMethod::GET, "/users/:id", std::make_shared<MockHandler>("param_handler"));
        ...
        int result =
            r.find_route(HttpMethod::GET, "/users/admin", found_handler, params, query_params);
        assert(result == 0);
        assert(found_handler->name == "static_handler");

        // Parameter route should still work
        result = r.find_route(HttpMethod::GET, "/users/123", found_handler, params, query_params);
        assert(result == 0);
    ...
    void test_url_encoding()
    {
        ...
        router<MockHandler> r;
        r.add_route(HttpMethod::GET, "/search", std::make_shared<MockHandler>("search_handler"));
    ...
    void test_edge_cases()
    {
        ...
        int result = r.find_route(HttpMethod::GET, "", found_handler, params, query_params);
        assert(result == -1);

        // Root path
        r.add_route(HttpMethod::GET, "/", std::make_shared<MockHandler>("root_handler"));
        result = r.find_route(HttpMethod::GET, "/", found_handler, params, query_params);
        assert(result == 0);
        assert(found_handler->name == "root_handler");

        // Unknown HTTP method
        result = r.find_route(HttpMethod::UNKNOWN, "/", found_handler, params, query_params);
        assert(result == -1);

        // Very long path
        std::string long_path = "/very/long/path/with/many/segments/that/goes/on/and/on";
        r.add_route(HttpMethod::GET, long_path, std::make_shared<MockHandler>("long_handler"));
        result = r.find_route(HttpMethod::GET, long_path, found_handler, params, query_params);
        assert(result == 0);
    ...
    void test_route_priority()
    {
        ...
        r.add_route(HttpMethod::GET, "/api/*", std::make_shared<MockHandler>("wildcard_handler"));
        r.add_route(HttpMethod::GET, "/api/users", std::make_shared<MockHandler>("static_handler"));
        ...
        result = r.find_route(HttpMethod::GET, "/api/posts", found_handler, params, query_params);
        assert(result == 0);
        assert(found_handler->name == "param_handler");
        assert(params["resource"] == "posts");

        // Wildcard should catch everything else
        result = r.find_route(HttpMethod::GET, "/api/very/deep/path", found_handler, params,
                              query_params);
        assert(result == 0);
    ...
    void test_segment_optimization()
    {
        ...
        r.add_route(HttpMethod::GET, "/a", std::make_shared<MockHandler>("1_segment"));
        r.add_route(HttpMethod::GET, "/a/b", std::make_shared<MockHandler>("2_segments"));
        r.add_route(HttpMethod::GET, "/a/b/c", std::make_shared<MockHandler>("3_segments"));
        r.add_route(HttpMethod::GET, "/a/b/c/d", std::make_shared<MockHandler>("4_segments"));
        ...
        int result = r.find_route(HttpMethod::GET, "/a", found_handler, params, query_params);
        assert(result == 0);
        assert(found_handler->name == "1_segment");

        result = r.find_route(HttpMethod::GET, "/a/b", found_handler, params, query_params);
        assert(result == 0);
        assert(found_handler->name == "2_segments");

        result = r.find_route(HttpMethod::GET, "/a/b/c", found_handler, params, query_params);
        assert(result == 0);
        assert(found_handler->name == "3_segments");

        result = r.find_route(HttpMethod::GET, "/a/b/c/d", found_handler, params, query_params);
        assert(result == 0);
    ...
    void test_performance_large_number_of_routes()
    {
        ...
        std::cout << "  Registration time for " << num_routes << " routes: " << registration_time
                  << "ms" << std::endl;
        std::cout << "  Average lookup time: " << lookup_time / lookup_iterations << "ms per lookup"
                  << std::endl;
    ...
    void test_performance_parameterized_routes()
    {
        ...
        std::cout << "  Parameterized route registration time: " << registration_time << "ms"
                  << std::endl;
        std::cout << "  Average parameterized lookup time: " << lookup_time / lookup_iterations
    ...
    void test_performance_wildcard_routes()
    {
        ...
        for (int i = 0; i < num_routes; ++i) {
            ...
            r.add_route(HttpMethod::GET, path,
                        std::make_shared<MockHandler>("wildcard_handler_" + std::to_string(i)));
        }
        ...
        std::cout << "  Wildcard route registration time: " << registration_time << "ms"
                  << std::endl;
        std::cout << "  Average wildcard lookup time: " << lookup_time / lookup_iterations
                  << "ms per lookup" << std::endl;
    ...
    void test_performance_cache_efficiency()
    {
        ...
        for (int i = 0; i < cache_iterations; ++i) {
            result = r.find_route(HttpMethod::GET, "/api/v1/users/123/posts/456/comments/789",
                                  found_handler, params, query_params);
            assert(result == 0);
            params.clear();
        }
        ...
        std::cout << "  Average warm lookup time: " << warm_lookups / cache_iterations << "ms"
                  << std::endl;
        std::cout << "  Cache speedup: " << (cold_lookup / (warm_lookups / cache_iterations)) << "x"
                  << std::endl;
    ...
    void test_performance_concurrent_access()
    {
        ...
        for (int t = 0; t < num_threads; ++t) {
            futures.push_back(std::async(std::launch::async, [&r, requests_per_thread, t]() -> int {
    ...
    void test_static_routes_comprehensive()
    {
        ...
        for (const auto &[path, handler_name] : static_routes) {
            r.add_route(HttpMethod::GET, path, std::make_shared<MockHandler>(handler_name));
        }
    ...
    void test_parameterized_routes_comprehensive()
    {
        ...
        r.add_route(HttpMethod::GET, "/users/:id", std::make_shared<MockHandler>("user_by_id"));
        r.add_route(HttpMethod::GET, "/posts/:slug", std::make_shared<MockHandler>("post_by_slug"));
    ...
    void test_wildcard_routes_comprehensive()
    {
        ...
        r.add_route(HttpMethod::GET, "/static/*", std::make_shared<MockHandler>("static_files"));
        r.add_route(HttpMethod::GET, "/uploads/*", std::make_shared<MockHandler>("upload_files"));
    ...
    void test_query_parameter_parsing_comprehensive()
    {
        ...
        router<MockHandler> r;
        r.add_route(HttpMethod::GET, "/search", std::make_shared<MockHandler>("search_handler"));
        r.add_route(HttpMethod::GET, "/api/users", std::make_shared<MockHandler>("users_api"));
        ...
        for (const auto &[url, expected_query_params] : test_cases) {
            ...
            int result = r.find_route(HttpMethod::GET, url, found_handler, params, query_params);
            assert(result == 0);
            assert(found_handler != nullptr);
    ...
    void test_route_caching_optimization()
    {
        ...
        timer.reset();
        int result = r.find_route(HttpMethod::GET, "/api/v1/users/123/posts/456?sort=date",
                                  found_handler, params, query_params);
        ...
        for (int i = 0; i < cache_test_iterations; ++i) {
            params.clear();
            query_params.clear();
            result = r.find_route(HttpMethod::GET, "/api/v1/users/123/posts/456?sort=date",
                                  found_handler, params, query_params);
            assert(result == 0);
        }
        ...
        std::cout << "  Average warm lookup time: " << avg_warm_time << "ms" << std::endl;
        std::cout << "  Cache performance improvement: " << (cold_time / avg_warm_time) << "x"
                  << std::endl;

        // Test cache with different routes
        std::vector<std::string> cache_test_routes = {
            "/api/v1/users/789/posts/101?filter=published", "/static/assets/images/logo.png",
            "/api/v1/users/456/posts/789?include=comments", "/static/assets/css/main.css"};
        ...
        for (int i = 0; i < 100; ++i) {
            for (const auto &route : cache_test_routes) {
                params.clear();
                query_params.clear();
                result = r.find_route(HttpMethod::GET, route, found_handler, params, query_params);
                assert(result == 0);
            }
        }
        double multi_route_cache_time = timer.elapsed_ms();

        std::cout << "  Multi-route cache test time: " << multi_route_cache_time << "ms for "
                  << (cache_test_routes.size() * 100) << " lookups" << std::endl;
        std::cout << "  Average cached lookup: "
                  << (multi_route_cache_time / (cache_test_routes.size() * 100)) << "ms"
                  << std::endl;
        ...
        std::cout << "  Post-cache-clear lookup time: " << post_clear_time << "ms" << std::endl;
    ...
    void test_large_scale_mixed_routes()
    {
        ...
        for (int i = 0; i < lookup_iterations; ++i) {
            ...
            if (route_type == 0) {
                ...
                result = r.find_route(HttpMethod::GET, path, found_handler, params, query_params);
            } else if (route_type == 1) {
                // Test parameterized route
                int route_id = i % num_param_routes;
                std::string path = "/api/v" + std::to_string(route_id % 5) + "/resource" +
                ...
                std::string path = "/files/type" + std::to_string(route_id) + "/documents/file.pdf";
                result = r.find_route(HttpMethod::GET, path, found_handler, params, query_params);
                if (result == 0) {
        ...
        std::cout << "  Performed " << lookup_iterations << " mixed lookups in " << lookup_time
                  << "ms" << std::endl;
